...
tetmesh 	Tetmesh ;
const char *FLOAT_OUTPUT_FORMAT_SPEC = "%23.16E"; // field width is 26, 16 decimal digits, exponential notation with big E
const char *INT_OUPTUT_FORMAT_SPEC = "%8d"; // Field width is 8, number is integer
...
void read_tetmesh()
{
	...
	printf("The Code reads tetrahedral meshes and outputs CENTAUR mesh format. \n\n") ;
